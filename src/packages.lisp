(defpackage :cffi-helper
  ...
  (:export :define-cffi-return-types :defcstruct* :defcfun* :zero-memory :with-cffi-readers :with-cffi-ptrs :make-cffi-context :with-cffi-context :with-array-ptrs :make-array-context :with-array-context))
